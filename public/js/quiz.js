...
function finishTest() {
    ...
    $("#stage").html("");
    $("#stage").append("<a href='javascript:checkTestResult();' title='Check Result'><img src='/public/images/time_over.png' alt='Test is Over'/></a>");
...
function nextQuestion(prefix) {
    ...
    $("#stage").load(prefix + "/" + questionID + ".htm?QN=" + currentQ, function() {
        ...
        if (timeout) {
            $("#stage").html("");
            $("#stage").append("<a href='javascript:checkTestResult();' title='Check Result'><img src='/public/images/time_over.png' alt='Time is Over'/></a>");
